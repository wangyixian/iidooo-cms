...
INSERT INTO `IDO_DICT_ITEM` (`DictClassCode`, `DictItemCode`, `DictItemName`, `DictItemValue`, `Sequence`, `IsDefault`, `IsDisable`, `IsReadonly`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) 
VALUES ('PROPERTIES_SITE', 'UPLOAD_MAX_SIZE', '上传最大文件大小单位B', '1000000', 5, 0, 0, 0,'', now(), 1, now(), 1, 0, 1);
...
-- IDO_FIELD_MODEL
INSERT INTO `IDO_FIELD_MODEL` (`ModelName`, `TableName`, `Sequence`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) 
VALUES ('产品', 'IDO_CMS_CONTENT', 1, '', now(), 1, now(), 1, 0, 1);

-- IDO_FIELD_CONFIG
INSERT INTO `IDO_FIELD_CONFIG` (`ModelID`, `FieldCode`, `FieldTitle`, `FieldType`, `Sequence`, `DictClassCode`, `DefaultValue`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) 
VALUES (1, 'ProductType', '产品类型', 6, 1, 'FIELD_PRODUCT_TYPE', '', '', now(), 1, now(), 1, 0, 1);
INSERT INTO `IDO_FIELD_CONFIG` (`ModelID`, `FieldCode`, `FieldTitle`, `FieldType`, `Sequence`, `DictClassCode`,  `DefaultValue`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) 
VALUES (1, 'ProductCountry', '产品国家', 6, 2, 'FIELD_PRODUCT_COUNTRY', '', '', now(), 1, now(), 1, 0, 1);
INSERT INTO `IDO_FIELD_CONFIG` (`ModelID`, `FieldCode`, `FieldTitle`, `FieldType`, `Sequence`, `DictClassCode`,  `DefaultValue`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) 
VALUES (1, 'ProductOrigin', '产品产地', 6, 3, 'FIELD_PRODUCT_ORIGIN', '', '', now(), 1, now(), 1, 0, 1);
...
-- 产品介绍内容
INSERT INTO `IDO_CMS_CONTENT` 
(`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) 
VALUES (1, 2, 8, '德国皇冠司令白葡萄酒', '子标题', '/inaba/product/德国皇冠司令白葡萄酒/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', '', now(), '1', now(), '1', '0', '1');
INSERT INTO `IDO_CMS_CONTENT` 
(`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) 
VALUES (1, 2, 8, '德国皇冠司令白葡萄酒', '子标题', '/inaba/product/德国皇冠司令白葡萄酒/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', ' ', now(), '1', now(), '1', '0', '1');
INSERT INTO `IDO_CMS_CONTENT` 
...
-- 红酒资讯
INSERT INTO `IDO_CMS_CONTENT` (`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) VALUES (1, 3, 9,'红酒资讯', '子标题', '/inaba/info/红酒资讯1/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', '', now(), '1', now(), '1', '0', '1');
INSERT INTO `IDO_CMS_CONTENT` (`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) VALUES (1, 3, 9,'红酒资讯', '子标题', '/inaba/info/红酒资讯1/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', ' ', now(), '1', now(), '1', '0', '1');
INSERT INTO `IDO_CMS_CONTENT` (`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) VALUES (1, 3, 9,'红酒资讯', '子标题', '/inaba/info/红酒资讯1/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', ' ', now(), '1', now(), '1', '0', '1');
INSERT INTO `IDO_CMS_CONTENT` (`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) VALUES (1, 3, 9,'红酒资讯', '子标题', '/inaba/info/红酒资讯1/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', ' ', now(), '1', now(), '1', '0', '1');
INSERT INTO `IDO_CMS_CONTENT` (`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) VALUES (1, 3, 9,'红酒资讯', '子标题', '/inaba/info/红酒资讯1/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', ' ', now(), '1', now(), '1', '0', '1');
...
INSERT INTO `IDO_CMS_CONTENT` (`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) VALUES (1, 8, 9,'全球最昂贵葡萄酒2014排名出炉', '子标题', '/inaba/info/全球最昂贵葡萄酒2014排名出炉/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', '', now(), '1', now(), '1', '0', '1');

INSERT INTO `IDO_CMS_CONTENT` (`ModelID`, `ChannelID`, `TemplateID`, `ContentTitle`, `ContentSubTitle`, `ContentImageTitle`, `MetaTitle`, `MetaKeywords`, `MetaDescription`, `ContentSummary`, `ContentBody`, `Sequence`, `IsAllowComment`, `Remarks`, `CreateTime`, `CreateUser`, `UpdateTime`, `UpdateUser`, `IsDelete`, `Version`) VALUES (1, 8, 9,'THANKSGIVING 感恩节餐酒搭配', '子标题', '/inaba/info/THANKSGIVING感恩节餐酒搭配/title/1.jpg', 'meta标题', 'meta关键字', 'meta描述', '摘要', '内容', '1', '0', '', now(), '1', now(), '1', '0', '1');
