...
public class ContentDetailProductAction extends ContentDetailAction {
    ...
    private static final Logger logger = Logger.getLogger(ContentDetailProductAction.class);
