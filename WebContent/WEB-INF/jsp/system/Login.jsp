...
<link type="text/css" rel="stylesheet" href="/iidooo-cms/css/Login.css">
	...
	<form action="login.action" method="post">
		<div class="auth_form">
			...
			<div class="auth_form_body">
				<label>用户名：</label><br> <input class="input_text" type="text" name="loginID"> <label>密码：</label><br> <input class="input_text"
