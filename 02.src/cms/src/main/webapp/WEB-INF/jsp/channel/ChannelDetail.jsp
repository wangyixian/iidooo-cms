			...
			<div>
				...
				<table class="grid">
					<tr>
						...
						<td>
							<s:select list="allChannels" listKey="channelID" listValue="channelName"></s:select>
						</td>
						<th class="required" width="10%">栏目模板</th>
						<td>
							<s:select list="allTemplates" listKey="templateID" listValue="templatePath"></s:select>
						</td>
					</tr>
					<tr>
