    ...
    render: function () {
        return (
            <div>
                ...
                <input id="loginID" type="text" className="form-control" value={this.state.loginID} placeholder="请输入用户名"
                       onChange={this.handleChange.bind(null, 'loginID')}/>
                <label htmlFor="password" className="sr-only">密码</label>
                <input id="password" type="password" className="form-control" value={this.state.password} placeholder="请输入密码"
