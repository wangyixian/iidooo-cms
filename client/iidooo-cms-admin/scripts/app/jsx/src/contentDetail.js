                    ...
                    <div className="panel-body">
                        ...
                        <div className="row form-group form-horizontal">
                            <div className="col-xs-6">
                                ...
                                <div className="col-xs-8">
                                    <input id="contentImageTitle" type="text" className="form-control"
                            ...
                            <div className="col-xs-6">
                                ...
                                <div className="col-xs-8">
                                    ...
                                    <select id="selContentBodyFileType" className="form-control" defaultValue="3">
                                        ...
                                        <textarea id="contentBody" ref="inputContentBody" cols="100" rows="30" className="form-control"
...
$("#uploadImageTitle").fileupload({
    ...
    maxNumberOfFiles: 1,
    formData: {'appID': appID, 'secret': secret, 'accessToken': $.cookie("ACCESS_TOKEN"), 'fileType': '1'},
